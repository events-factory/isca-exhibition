...
export const INITIAL_BOOTHS: Booth[] = [
  ...
  { id: '03', category: 4, size: '9mx3m', status: 'available', location: 'Foyer 1A' },

  // Foyer 1C
  { id: '04', category: 3, size: '6mx3m', status: 'available', location: 'Foyer 1C' },
  { id: '05', category: 3, size: '6mx3m', status: 'available', location: 'Foyer 1C' },
  { id: '19', category: 1, size: '3mx2m', status: 'available', location: 'Foyer 1C' },
  { id: '20', category: 1, size: '3mx2m', status: 'available', location: 'Foyer 1C' },

  // No Man's Land - Category 3 (6mx3m, Orange)
  { id: '06', category: 3, size: '6mx3m', status: 'available', location: "No Man's Land" },
  { id: '07', category: 3, size: '6mx3m', status: 'available', location: "No Man's Land" },

  // Foyer 1B - Vertical strip booths
  { id: '08', category: 2, size: '3mx3m', status: 'available', location: 'Foyer 1B' },
  { id: '09', category: 2, size: '3mx3m', status: 'available', location: 'Foyer 1B' },
  { id: '10', category: 2, size: '3mx3m', status: 'available', location: 'Foyer 1B' },
  { id: '11', category: 2, size: '3mx3m', status: 'available', location: 'Foyer 1B' },
  { id: '12', category: 2, size: '3mx3m', status: 'available', location: 'Foyer 1B' },
  { id: '13', category: 2, size: '3mx3m', status: 'available', location: 'Foyer 1B' },
  { id: '14', category: 2, size: '3mx3m', status: 'available', location: 'Foyer 1B' },
  { id: '15', category: 1, size: '3mx2m', status: 'available', location: 'Foyer 1B' },
  { id: '16', category: 1, size: '3mx2m', status: 'available', location: 'Foyer 1B' },
  { id: '17', category: 1, size: '3mx2m', status: 'available', location: 'Foyer 1B' },
  { id: '18', category: 1, size: '3mx2m', status: 'available', location: 'Foyer 1B' },

  // AD11&AD12 Exhibition - Category 6 (10mx10m, Red)
  { id: '21', category: 6, size: '10mx10m', status: 'available', location: 'AD11&AD12 Exhibition' },

  // Concourse
  { id: '22', category: 5, size: '12mx3m', status: 'available', location: 'Concourse' },
  { id: '23', category: 1, size: '3mx2m', status: 'available', location: 'Concourse' },
  { id: '24', category: 1, size: '3mx2m', status: 'available', location: 'Concourse' },
  { id: '25', category: 1, size: '3mx2m', status: 'available', location: 'Concourse' },
  { id: '26', category: 4, size: '9mx3m', status: 'available', location: 'Concourse' },
  { id: '27', category: 1, size: '3mx2m', status: 'available', location: 'Concourse' },
  { id: '28', category: 1, size: '3mx2m', status: 'available', location: 'Concourse' },
  { id: '29', category: 1, size: '3mx2m', status: 'available', location: 'Concourse' },

  // Square Tent (45mx25m)
  { id: '30', category: 3, size: '6mx3m', status: 'available', location: 'Square Tent' },
  { id: '31', category: 2, size: '3mx3m', status: 'available', location: 'Square Tent' },
  { id: '32', category: 1, size: '3mx2m', status: 'available', location: 'Square Tent' },
  { id: '33', category: 1, size: '3mx2m', status: 'available', location: 'Square Tent' },
  { id: '34', category: 1, size: '3mx2m', status: 'available', location: 'Square Tent' },
  { id: '35', category: 1, size: '3mx2m', status: 'available', location: 'Square Tent' },
  { id: '36', category: 1, size: '3mx2m', status: 'available', location: 'Square Tent' },
  { id: '37', category: 1, size: '3mx2m', status: 'available', location: 'Square Tent' },
  { id: '38', category: 1, size: '3mx2m', status: 'available', location: 'Square Tent' },
  { id: '39', category: 1, size: '3mx2m', status: 'available', location: 'Square Tent' },
  { id: '40', category: 1, size: '3mx2m', status: 'available', location: 'Square Tent' },
  { id: '41', category: 1, size: '3mx2m', status: 'available', location: 'Square Tent' },
  { id: '42', category: 3, size: '6mx3m', status: 'available', location: 'Square Tent' },
  { id: '43', category: 3, size: '6mx3m', status: 'available', location: 'Square Tent' },
